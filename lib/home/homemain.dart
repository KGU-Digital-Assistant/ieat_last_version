...
class _Home_SfState extends State<Home_Sf> with TickerProviderStateMixin {
  ...
  List<bool> isNuFin = [false, false, false];
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      ...
      homeMainBottomPart(context,today);
      final pv = Provider.of<HomeSave>(context, listen: false);
      int carbCount = ((pv.todayMainData['carb'].floor() ?? 0).toDouble() /
              (pv.todayMainData['gb_carb'].floor() ?? 0).toDouble() *
              100)
          .toInt(); // 예시로 100을 곱함
      int probCount = ((pv.todayMainData['protein'].floor() ?? 0).toDouble() /
              (pv.todayMainData['gb_protein'].floor() ?? 0).toDouble() *
              100)
          .toInt(); // 예시로 100을 곱함
      int fatbCount = ((pv.todayMainData['fat'].floor() ?? 0).toDouble() /
              (pv.todayMainData['gb_fat'].floor() ?? 0).toDouble() *
              100)
          .toInt(); // 예시로 100을 곱함
          ...
          SizedBox(
            ...
            child: Center(
              child: ElevatedButton(
                onPressed: () async {
                  await updateBurncalorie_PATCH(
                      context, _selectedBurnCalorieValue.toDouble());
        ...
        children: [
          ...
          SizedBox(
            ...
            child: Center(
              child: ElevatedButton(
                onPressed: () async {
                  await updateWeght_PATCH(
                      context, _selectedWeghtValue.toDouble());
                },
                style: ButtonStyle(
                  padding: MaterialStateProperty.all<EdgeInsets>(
                    EdgeInsets.fromLTRB(10, 5, 10, 5),
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
        ...
        child: Scaffold(
          ...
          body: Consumer<HomeSave>(builder: (context, pv, child) {
                  ...
                  children: [
                    ...
                    Container(
                        decoration: BoxDecoration(
                          ...
                          color: ColorMainBack,
                          border: Border.all(
                              color: mainGrey.withOpacity(0.5), width: 1.5),
                              ...
                              children: [
                                SizedBox(
                                  ...
                                  child: Align(
                                      ...
                                      child: RichText(
                                        ...
                                        TextSpan(
                                          text:
                                              "${pv.todayWeightCalories['todayCalorie'].floor()}",
                                ...
                                SizedBox(
                                  ...
                                  child: Align(
                                      ...
                                      child: Text(
                                        "목표 칼로리 : ${pv.todayWeightCalories['goalCalorie'].floor()}kcal",
                                        ...
                                        SizedBox(
                                            ...
                                            child: Padding(
                                              ...
                                              child: Align(
                                                ...
                                                child: Text(
                                                    // "81",
                                                    "${pv.todayMainData['protein'].floor()}",
                                                    style: TextStyle(
                                                        fontSize: 13,
                                                        color: Colors.grey,
                                                        fontWeight:
                                      ...
                                      child: Padding(
                                          ...
                                          child: Consumer<HomeSave>(
                                            builder: (context, pv, child) {
                                              return Text(
                                                  '${pv.todayWeightCalories['nowCalorie'].floor()}',
                                                  style: TextStyle(
                                                    color: mainBlack,
                                    ...
                                    Align(
                                      ...
                                      child: Padding(
                                          ...
                                          child: Consumer<HomeSave>(
                                            builder: (context, pv, child) {
                                              return Text(
                                                  '${pv.todayWeightCalories['burnCalorie'].floor()}',
                                                  style: TextStyle(
                                                    color: mainBlack,
                                                    fontFamily: 'Readex Pro',
                                                    fontSize: 21,
                                    ...
                                    Align(
                                      ...
                                      child: Padding(
                                          ...
                                          child: Consumer<HomeSave>(
                                            builder: (context, pv, child) {
                                              return Text(
                                                  '${pv.todayWeightCalories['weight'].floor()}',
                                                  style: TextStyle(
                                                    color: mainBlack,
                                                    fontFamily: 'Readex Pro',
                                                    fontSize: 21,
                    ...
                    Container(
                        ...
                        constraints: BoxConstraints(
                          minHeight:
                              MediaQuery.of(context).size.width * 1, // 최소 높이
                        ),
                        width: double.maxFinite,
                      ...
                      child: Padding(
                        ...
                        child: Container(
                            ...
                            child: SingleChildScrollView(
                              ...
                              child: Consumer<HomeSave>(
                                  builder: (build, pv, child) {
                                    var list = pv.todaySaveMeal['saveList'];
                                return Row(
                                  children: List.generate(
                                      list.length + 1,
                                          (idx) => idx == 0
                                          ...
                                          onPressed: () {
                                            final mpv = Provider.of<
                                                ...
                                                listen: false);
                                            final opv =
                                            Provider.of<OneFoodDetail>(
                                                context,
                                                listen: false);
                                            mpv.clear();
                                            opv.clear();
                                            NvgToNxtPageSlide(context,
                                                MealSave(type: 'save'));
                                          },
                                          style: ButtonStyle(
                                              minimumSize:
                                          ...
                                          : pv.todaySaveMeal['saveList'].length == 0
                                          ? SizedBox()
                                          : Container(
                                        width: 75,
                                        height: 105,
                                        ...
                                        child: Column(
                                          ...
                                          children: [
                                            ElevatedButton(
                                                ...
                                                child: Container(
                                                  ...
                                                  decoration: BoxDecoration(
                                                    ...
                                                    //     image: AssetImage('${pv.todaySaveMeal['saveList']['picture']}'),
                                                    //     fit: BoxFit.fill
                                                    // ),
                                                    borderRadius:
                                                    BorderRadius
                                                  ...
                                                  child: ClipRRect(
                                                    ...
                                                    child: Image.network(
                                                      '${pv.todaySaveMeal['saveList'][idx-1]["picture"]}',
                                                      fit: BoxFit.cover,
                                                      width: 70,
                                                      height: 70,
                                                    ),
                                            ...
                                            SizedBox(height: 3),
                                            Text(
                                                '${pv.todaySaveMeal['saveList'][idx-1]["date"]}',
                                                textAlign:
                                                TextAlign.center,
                                                style: TextStyle(
                                                  fontSize: 12,
