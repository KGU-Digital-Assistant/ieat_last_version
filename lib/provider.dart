...
//선택한 날짜의 주차와 요일
  ...
  Map<int,dynamic> _homeOfTheWeek ={  //트랙 시작되어야 기록할 수 있음
    1 : {
      "월" : {},
      "화" : {},
      "수" : {},
...
//현재 사용자의 트랙 진행 여부 저장
  ...
  void setWeekDay(int weekCnt, String weekDay, String today) {
    if (homeOfTheWeek.containsKey(weekCnt) && homeOfTheWeek[weekCnt][weekDay].isEmpty) {
...
class OneTrackDetailInfoProvider with ChangeNotifier {
  String _pageType = "생성";
  Map<String, dynamic> _oneTrackInfo = {  //초기값 세팅
    "tid" : 0,
    "name": "",
    "icon" : "Melting face",
    "calorie" : 0,
...
//[일별데이터] : 건강정보
  void setHealth(Map<String, dynamic> data){
    _dailyInfo['health']['totalCalorie']= data['todaycalorie'] == null ? 0 : data['todaycalorie'];
    _dailyInfo['health']['goalCalorie']= data['goalcalorie'] == null ? 0 : data['goalcalorie'];
    _dailyInfo['health']['saveCalorie']= data['nowcalorie'] == null ? 0 : data['nowcalorie'];
    _dailyInfo['health']['burnCalorie']= data['burncalorie'] == null ? 0 : data['burncalorie'];
    _dailyInfo['health']['Weight']= data['weight'] == null ?0 : data['weight'];
    notifyListeners();
  }
//[일별데이터] : 식단 기록 리스트
...
class OneRoutineDetailInfoProvider with ChangeNotifier {
  String _pageType = "생성";
  Map<String, dynamic> _oneRoutineInfo = {  //초기값 세팅
    "rid" : 0,
    "rdateid" : 0,
    "title": "새로운 루틴",
    "clock": "01:00:00.975Z",
...
class OneMealDetailInfoProvider with ChangeNotifier {


  Map<String, dynamic> _mealInfo = {  //초기값 세팅
    "img" : 0,
    "time" : 0,
    "mealname": "식단 이름",
  };
  Map<String,dynamic> get mealInfo => _mealInfo;


  //식단 클릭 시 작동clear와 함께 작동
  // void set(Map<String, dynamic> data){
  //
  // };

  void setimg(String data){
    _mealInfo['img'] = data;
    notifyListeners();
  }
  ...
  void setmealname(String data, int idx){
    _mealInfo['mealname'] = "$data $idx";
    notifyListeners();
  }
}