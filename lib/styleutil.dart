...
const Color calenderClearRoutine = Color(0xFF14AE5C);
const Color calenderSaveRoutine = Color(0xFFECFCE5);

const TextAppbar = TextStyle(fontSize: 17, fontWeight: FontWeight.bold,color: mainBlack);
...
var Text11Black =  TextStyle(fontSize: 11, color: Colors.black);
