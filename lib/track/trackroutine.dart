...
class _RoutineDetailState extends State<RoutineDetail> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      ...
      createRoutine_1_POST(context,1);
    });
  }
              ...
              builder: (context,pv,child){
                return Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      SizedBox(height: 10,),
                      Text('${selectedDate[0]}주차 ${selectedDate[1]}요일', style: TextStyle(color: mainBlack, fontSize: 14, fontWeight: FontWeight.w600)),  //루틴명
                      Stack(
                        children: [
                          if (isEditing)
                            Row(
                              children: [
                                SizedBox(
                                    ...
                                    height: 50,
                                    child : TextField(
                                      style: Text24BoldBlack, // 입력하는 텍스트 스타일
                                      ...
                                      controller: controller..text = rnm, // 기존 텍스트로 초기화
                                      onSubmitted: (newText) {
                                        setState(() {
                                ...
                                Align(
                                  ...
                                  child: Padding(
                                      ...
                                      child: SizedBox(
                                          ...
                                          child: TextButton(
                                            style: ButtonStyle(
                                              padding: MaterialStateProperty.all<EdgeInsets>(EdgeInsets.zero), // 패딩 없애기
                                  ...
                                  SizedBox(
                                    child: Align(
                                        ...
                                        child: TextButton(style: ButtonStyle(
                                            ...
                                            }, child: Text('${pv.oneRoutineInfo['title'] ?? "새로운 루틴"}', style: Text24BoldBlack))
                                    ),
                                  ),
                                  SizedBox(
                                    height: 44,
                                    child: Align(
                                      alignment: Alignment.bottomLeft,
                                      child: Icon(Icons.create_outlined, color: mainBlack, size: 20),
                                    ),
                                  )
                                ],
                              ),
